  ...
  const sendgrid_options = {
    ...
    body: JSON.stringify({
      personalizations: [{
        ...
        subject: 'Thank you for purchasing our Digital Product!',
      }],
